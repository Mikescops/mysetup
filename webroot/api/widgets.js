...
iframe.height=0;iframe.width=frame.getAttribute('ms-width');iframe.src='https://mysetup.co/embed/'+frame.getAttribute('ms-setup');frame.innerHTML="";frame.prepend(iframe)});function resizeIframe(obj){obj.height=obj.width*0.8+'px'}
