                ...
                <div class="fullitem-inner">
                    ...
                    <div class="row">
                        ...
                        <div class="column column-75">
                            ...
                            <a href="<?= $this->Url->build('/setups/'.$setup->id.'-'.$this->Text->slug($setup->title)); ?>"><h3><?= h($setup->title) ?> <?php if($setup->status == 'DRAFT'): ?><i title="Only you can see this setup" class="fa fa-eye-slash setup-unpublished"></i><?php endif ?></h3></a>
