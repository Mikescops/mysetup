<div id="embed_twitch_modal" class="lity-hide">
    ...
    <a class="button" href="https://www.twitch.tv/ext/nx4cn1zq653a759wfy4aku0fgmql8l" target="_blank"><i class="fa fa-shopping-bag"></i>  <?= __('Install via Twitch MarketPlace') ?></a>
