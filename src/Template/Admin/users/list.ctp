                            ...
                            <?php if ($user->uwebsite or $user->ufacebook or $user->utwitter or $user->utwitch) : ?>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <?php if ($user->uwebsite) : echo '<a class="dropdown-item" href="' . h($user->uwebsite) . '" title="' . h($user->uwebsite) . '" target="_blank">Website</a>';
                                                endif; ?>
                                        <?php if ($user->ufacebook) : echo '<a class="dropdown-item" href="' . h($user->ufacebook) . '" title="' . h($user->ufacebook) . '" target="_blank">Facebook</a>';
                                                endif; ?>
                                        <?php if ($user->utwitter) : echo '<a class="dropdown-item" href="' . h($user->utwitter) . '" title="' . h($user->utwitter) . '" target="_blank">Twitter</a>';
                                                endif; ?>
