        ...
        <div class="col-xl-3 col-sm-6">
            <div class="card text-white bg-danger h-100">
                <div class="card-body bg-danger">
                    <div class="rotate">
                        <h1 class="display-4"><?= $stats['count']['setups'] ?> <i class="fa fa-list"></i></h1> <?= __('SETUPS') ?>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6">
            <div class="card bg-success text-white h-100">
                <div class="card-body bg-success">
                    <div class="rotate">
                        <h1 class="display-4"><?= $stats['count']['users'] ?> <i class="fa fa-users"></i></h1> <?= __('USERS') ?>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6">
            <div class="card text-white bg-info h-100">
                <div class="card-body bg-info">
                    <div class="rotate">
                        <h1 class="display-4"><?= $stats['count']['comments'] ?> <i class="fa fa-comments"></i></h1> <?= __('COMMENTS') ?>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-sm-6">
            <div class="card text-white bg-warning h-100">
                <div class="card-body bg-warning">
                    <div class="rotate">
                        <h1 class="display-4"><?= $stats['count']['resources'] ?> <i class="fa fa-database"></i></h1> <?= __('RESOURCES') ?>
                    </div>
                            ...
                            <div class="media-body">
                                <div class="d-flex w-100 justify-content-between">
                                    <h5 class="mb-1"><?= h($user->name) ?>
                                        <?php if(is_null($user->mailVerification)):?><i class="fa fa-envelope" title="<?= __('Mail verified') ?>"></i><?php endif;?>
                                        <?php if($user->twitchToken):?><i class="fa fa-twitch" title="<?= __('Twitch user id') ?> : <?= $user->twitchUserId ?>"></i><?php endif;?>
