...
<div class="col-12 col-md-9 col-xl-10">
    ...
    <div class="row mb-3">
        <div class="col-xl-3 col-sm-6">
            <br>
            <h3><?= __('Users Store') ?></h3>
            <canvas id="store-user" width="400" height="400"></canvas>
        </div>
        <div class="col-xl-3 col-sm-6">
            <br>
    ...
    <script>
        new Chart(document.getElementById("store-user"), {
            type: "doughnut",
            data: {
                labels: ["US", "UK", "FR", "ES", "IT", "DE"],
                datasets: [{
                    label: "<?= __('Users Store') ?>",
                    data: [
                        <?= $stats['users']['lang']['US'] ?>,
                        <?= $stats['users']['lang']['UK'] ?>,
                        <?= $stats['users']['lang']['FR'] ?>,
                    ...
                    backgroundColor: ["#00a1e0", "#ff70a6", "#ff9770", "#5ace62", "#ff053f", "#ce6321"]
                }]
            }
        });

        new Chart(document.getElementById("twitch-user"), {
            type: "doughnut",
            data: {
                labels: ["<?= __('Twitch users') ?>", "<?= __('Other users') ?>"],
                datasets: [{
                    label: "<?= __('Twitch users') ?>",
                    data: [
                        <?= $stats['users']['twitch'] ?>,
                        <?= 100 - $stats['users']['twitch'] ?>
                    ],
                    backgroundColor: ["#6441a5", "rgb(255, 99, 132)"]
                }]
            }
        });
    </script>
