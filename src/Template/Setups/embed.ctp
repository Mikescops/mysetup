...
<head>
	...
	<style type="text/css">
		abbr,acronym,address,applet,aside,audio,big,blockquote,body,canvas,caption,cite,dd,details,dfn,div,dt,em,embed,figcaption,figure,footer,form,h2,h3,h4,h5,h6,header,hgroup,html,i,img,ins,kbd,label,mark,menu,nav,object,ol,output,p,q,s,section,span,strike,strong,sub,sup,tbody,tfoot,th,thead,tr,tt,u,ul,video {
		    display: block
		}
		body {
		    line-height: 1;
		...
		blockquote:afterq:before, blockquote:before, q:after {
		    content: '';
		    content: none
		}
		table {
		...
		.item_box:hover, .Main-image:hover{
			opacity: 0.9;
