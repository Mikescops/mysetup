    ...
    <div class="featured-inner">
        ...
        <div class="row">
            ...
            <div class="column column-75">
                ...
                <h3><?= $setup->title ?></h3>
                <p>Shared by <?= $this->Html->link($additionalData['owner']['name'], ['controller' => 'users', 'action' => 'view', $additionalData['owner']['id']]) ?>  <?php if($additionalData['owner']['verified']): echo '<i class="fa fa-check-circle"></i>'; endif; ?></p>
