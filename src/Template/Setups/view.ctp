            ...
            <div class="row">
                <div class="column column-75">
                    <a class="featured-user" href="<?= $this->Url->build('/users/'.$setup->user['id']) ?>">
                        <img alt="<?= __('Profile picture of') ?> <?= h($setup->user['name']) ?>" src="<?= $this->Url->build('/uploads/files/pics/profile_picture_' . $setup->user_id . '.png?' . $this->Time->format($setup->user->modificationDate, 'Hs', null, null)) ?>">
                    </a>
        ...
        <div class="column column-60 column-offset-20">
            ...
            <?php if (!empty($setup->comments)): ?>
                ...
                <article class="comment">
                    <a class="comment-img" href="<?= $this->Url->build('/users/'.$comments->user_id)?>">
                        <img alt="<?= __('Profile picture of') ?> #<?= $comments->user_id ?>" src="<?= $this->Url->build('/uploads/files/pics/profile_picture_' . $comments->user_id . '.png?' . $this->Time->format($comments->user->modificationDate, 'Hs', null, null)) ?>" width="50" height="50" />
                    </a>
            ...
            <?php if($authUser): ?>
                ...
                <a class="comment-img" href="<?= $this->Url->build('/users/'.$authUser->id)?>">
                    <img alt="<?= __('Profile picture of') ?> #<?= $authUser->id ?>" src="<?= $this->Url->build('/uploads/files/pics/profile_picture_' . $authUser->id . '.png?' . $this->Time->format($authUser->modificationDate, 'Hs', null, null)) ?>" width="50" height="50" />
                </a>
